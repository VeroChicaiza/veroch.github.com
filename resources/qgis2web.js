...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [828476.069789, 10059482.122550, 830488.421500, 10062307.241750],
            units: 'degrees'})
    })
});


map.getView().fit([828758.468780, 10060810.290198, 830374.671914, 10061686.746221], map.getSize());
